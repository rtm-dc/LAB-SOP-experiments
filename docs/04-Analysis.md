...
We note that treatment effect estimates from two-way fixed effect (TWFE) event-study regressions "can be severely biased", even with homogeneous treatment effects. See [here](https://bcallaway11.github.io/did/articles/TWFE.html) for an example.
