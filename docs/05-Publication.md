...
- A [CRediT](https://onlinelibrary.wiley.com/doi/epdf/10.1087/20150211) statement that describes the role played by each of the authors for that specific document. We sometimes modify the roles to appropriately reflect the work done; see Section \@ref(sec-labcredit) below. If the document builds significantly on past outputs, those outputs should additionally be cited. 
...
### CRediT Roles at The Lab @ DC {#sec-labcredit}

We sometimes augment or alter the 14 standard CRediT roles to add accuracy or detail to our authorship contributions. We acknowledge contribution roles including

* _Statistical Design_: Quantitative analysis of design features such as power, bias, and outcome measurement; development of random assignment algorithms  
* _Subject Matter Expertise_: Provision of domain-specific knowledge, often from an agency perspective, that informs research design or interpretation 


## Publishing Data

We strive to post useful replication data to the extent possible in each
project. Some examples of our work doing so include projects on the 911 [nurse
triage line](https://github.com/thelabdc/FEMS-911NurseTriageLine-Public) and
457b [enrollment](https://github.com/thelabdc/DCHR-457b-Public).
...
When we want to communicate group estimates along with treatment effects, we
display them with barplots or scatterplots. Where we are interested in inference
about a treatment effect, we display the control group and treatment group
