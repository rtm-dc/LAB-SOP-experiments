...
```
## [[1]]
##   [1] "abind"         "askpass"       "backports"     "base"         
##   [5] "base64enc"     "bit"           "bit64"         "blob"         
##   [9] "blockTools"    "bookdown"      "boot"          "brew"         
...
##  [29] "conflicted"    "cpp11"         "crayon"        "credentials"  
##  [33] "crosstalk"     "curl"          "data.table"    "datasets"     
##  [37] "DBI"           "dbplyr"        "DeclareDesign" "desc"         
##  [41] "devtools"      "diffobj"       "digest"        "downlit"      
##  [45] "dplyr"         "DT"            "dtplyr"        "ellipsis"     
##  [49] "estimatr"      "evaluate"      "fabricatr"     "fansi"        
##  [53] "farver"        "fastmap"       "fontawesome"   "forcats"      
##  [57] "foreign"       "Formula"       "fs"            "gargle"       
##  [61] "generics"      "gert"          "ggplot2"       "gh"           
##  [65] "gitcreds"      "glue"          "googledrive"   "googlesheets4"
##  [69] "graphics"      "grDevices"     "grid"          "gtable"       
##  [73] "haven"         "here"          "highr"         "hms"          
##  [77] "htmltools"     "htmlwidgets"   "httpuv"        "httr"         
##  [81] "httr2"         "ids"           "ini"           "isoband"      
##  [85] "jquerylib"     "jsonlite"      "KernSmooth"    "knitr"        
##  [89] "labeling"      "later"         "lattice"       "lazyeval"     
##  [93] "lifecycle"     "lme4"          "lubridate"     "magrittr"     
##  [97] "markdown"      "MASS"          "Matrix"        "MatrixModels" 
## [101] "memoise"       "methods"       "mgcv"          "mime"         
## [105] "miniUI"        "minqa"         "modelr"        "munsell"      
## [109] "nlme"          "nloptr"        "nnet"          "numDeriv"     
## [113] "openssl"       "parallel"      "pbkrtest"      "pillar"       
## [117] "pkgbuild"      "pkgconfig"     "pkgdown"       "pkgload"      
## [121] "praise"        "prettyunits"   "processx"      "profvis"      
## [125] "progress"      "promises"      "ps"            "purrr"        
## [129] "quantreg"      "R6"            "ragg"          "randomizr"    
## [133] "rappdirs"      "rcmdcheck"     "RColorBrewer"  "Rcpp"         
## [137] "RcppEigen"     "readr"         "readxl"        "rematch"      
## [141] "rematch2"      "remotes"       "renv"          "reprex"       
## [145] "rlang"         "rmarkdown"     "roxygen2"      "rpart"        
## [149] "rprojroot"     "rstudioapi"    "rversions"     "rvest"        
## [153] "sass"          "scales"        "selectr"       "sessioninfo"  
## [157] "shiny"         "sourcetools"   "SparseM"       "spatial"      
## [161] "splines"       "stargazer"     "stats"         "stats4"       
## [165] "stringi"       "stringr"       "survival"      "sys"          
## [169] "systemfonts"   "tcltk"         "testthat"      "textshaping"  
## [173] "tibble"        "tidyr"         "tidyselect"    "tidyverse"    
## [177] "timechange"    "tinytex"       "tools"         "translations" 
## [181] "tzdb"          "urlchecker"    "usethis"       "utf8"         
## [185] "utils"         "uuid"          "vctrs"         "viridisLite"  
## [189] "vroom"         "waldo"         "whisker"       "withr"        
## [193] "xfun"          "xml2"          "xopen"         "xtable"       
## [197] "yaml"          "zip"
```
